...
deployVida:
	@forge script script/DeployvidaNft.s.sol:DeployvidaNft $(NETWORK_ARGS)

deployVidaToken:
	@forge script script/DeployvidaToken.s.sol:Deployvida $(NETWORK_ARGS)

Deposit:
	@forge script script/interactions.s.sol:depositToken $(NETWORK_ARGS)
